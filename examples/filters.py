...
class FilterForm(object):
    ...
    def parse_query_filters(self):
        ...
        def _dfs(node, prefix, models, join_columns):
            for field in node.fields:
                ...
                if qf_select in Request._params and qf_value in Request._params:
                    accum.setdefault(field, [])
                    accum[field].append((
                        Request._params.getlist(qf_select),
                        Request._params.getlist(qf_value),
                        models,
                        join_columns,
                        qf_select,
                        qf_value,
    ...
    def process_request(self, query):
        ...
        form = FormClass(Request._params)
